    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            //url = new URL("http://localhost:8080/b1timbrado_cliente_servidor/TimbradoCfdi?wsdl");
        } catch (MalformedURLException ex) {
            e = new WebServiceException(ex);
        } catch (IOException ex) {
            Logger.getLogger(TimbradoCfdi_Service.class.getName()).log(Level.SEVERE, null, ex);
        }
